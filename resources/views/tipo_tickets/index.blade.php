...
@section('content')
        ...
        <div class="well well-sm text-right">
            ...
            <a class="btn btn-primary agregar" href='{{url('/tipo_tickets/create')}}'>Crear nuevo tipo ticket!</a>
        </div>
        ...
        <table id="locaciones" class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$tipo->subtotal}}</td>
                    <td>{{$tipo->iva}}</td>
                    <td>{{$tipo->valorTotal}}</td>
                    <td>{{$tipo->cantidadTotal}}</td>
                    <td>{{$tipo->cantidadVendida}}</td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <a class="dropdown-item" href="/tipo_tickets/{{$tipo->idTipoTicket}}/edit"><i class="fas fa-pencil-alt iconos"></i>&nbsp; Editar</a>

                            <div class="dropdown-divider"></div>
                            <form action="{{route('tipo_tickets.destroy', $tipo->idTipoTicket)}}" method="post" class="btn-group">
                                @csrf
                                @method('DELETE')
